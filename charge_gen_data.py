...
columns = ['charge_id', 'business_product_instance_id',                   # названия колонок
           'charge_counter', 'date', 'cost', 'event_type']


instance = pd.read_csv('instance.csv')
    # names=['id', 'id-customer', 'id-product', 'active-day', 'termination-day', 'status', 'distribution'])
product = pd.read_csv('product.csv')
    # names=['product_id', 'product_name', 'product_type', 'recurrent', 'cost', 'allowance_sms', 'allowance_voice', 'allowance_data'])
